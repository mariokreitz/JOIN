...
function getTemplate() {
  return ` <div class="bigc-main-container">
      ...
      <textarea class="bc-m-left" name="" id="bc-description-textarea"></textarea>
      <p class="bc-duedate-head bc-m-left">Due date:</p>
      <div class="bc-duedate-input-containr bc-with bc-m-left">
        <input id="duedate-input" type="text" placeholder="dd/mm/yyyy" />
      ...
      <select class="bc-m-left bc-with" id="auswahl">
        <option value="option1">Option 1</option>
        <option value="option2">Option 2</option>
        <option value="option3">Option 3</option>
        <option value="option4">Option 4</option>
      </select>
      <div class="bc-show-selected-assigned bc-m-left bc-with">
        <div class="bc-card-initial-circle"><span>AM</span></div>
        <div class="bc-card-initial-circle"><span>AM</span></div>
      </div>
      ...
      <div class="bc-subtask-list bc-with bc-m-left" id="show-subtask-bc"></div>
      <button class="bc-end-button">
