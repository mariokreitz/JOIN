function getTaskCardBigTemplate(category, title, description, dueDate, priority, assignedMembers, subTasks) {
  return /*html*/ `
      <div class="big-card-modal">
        <div class="category-close-container">
          <div class="big-card-category">
            <h4 class="inter-extralight">${category}</h4>
          </div>
        ...
        <div class="big-card-createAT">
          <div class="big-card-date">
            <p>Due date:</p>
            <p class="user-createAt-p">${dueDate}</p>
          </div>
          <div class="big-card-priority">
            <p>Priority:</p>
            <div class="select-prio-big-card">
              <span class="big-card-select-prio">${priority}</span>
              <div class="prio-img">
        ...
        <div class="bigCard-subtasks-container">
          ${subTasks}
            <div class="bigCard-subtask">
              <img src="./assets/img/icons/subtask-non-checked.png" alt="Subtask Icon" />
              <p>${task}</p>
            </div>
        </div>
